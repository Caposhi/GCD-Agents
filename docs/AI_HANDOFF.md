...
1. **Phase 0B.6 — the dormant `final-critic` stage executor.** It is named only; it is not designed or implemented in this reconciliation. Beginning it requires separate scope and authorization.
...
2. **merged to `main`** — true for all five executors;
