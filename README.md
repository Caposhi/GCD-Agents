...
- **Genuinely still stale, from the 2026-08-24 21:32 UTC verification and not revisited since:** the GitHub `production` environment and its five non-secret variables, and the PostgreSQL external-access allowlist. Treat those as last-verified rather than current.
...
- Production PostgreSQL external access allowed `0.0.0.0/0` at the 2026-08-24 verification and was not revisited on 2026-08-28. Restriction is a separate high-priority security change.
